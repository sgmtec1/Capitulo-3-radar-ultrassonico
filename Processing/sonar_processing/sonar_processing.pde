...
import ddf.minim.*; // instalar biblioteca ferramentas add ferramentas 
...
void setup() {
  ...
  smooth();
  myPort = new Serial(this, "COM4", 9600); /* inicia comunicação serial. coloque a porta que o seu arduino esta ligada */
  ...
  player = minim.loadFile("/1-Arduino/capitulo 3 -/SonarEffect.mp3");
  player.rewind();
